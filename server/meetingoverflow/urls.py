...
urlpatterns = [
    ...
    # TextBlock
    path(
        "note/<int:n_id>/textblocks/",
        views.textblock_child_of_note,
        name="textblock_child_of_note",
    ),
    path(
        "agenda/<int:a_id>/textblocks/",
    ...
    # ImageBlock
    path(
        "note/<int:n_id>/images/", views.image_child_of_note, name="image_child_ofnote"
    ),
    path(
        "agenda/<int:a_id>/images/",
        views.image_child_of_agenda,
    ...
    path(
        "note/<int:n_id>/todos/",
        views.todoblock_child_of_note,
        name="todoblock_child_of_note",
    ),
    path(
        "agenda/<int:a_id>/todos/",
    ...
    path("tag/info/<int:t_id>/", views.tag_info, name="tag_info"),
